						...
						<div>
							<div data-scroll data-scroll-speed="2" data-scroll-delay="0.07">
								...
								<div class="pb-24 -mt-4">
									{#if frameWaited}
										<button
											class="btn btn-secondary text-white border-transparent hover:border-transparent bg-gradient-to-r from-green-500 via-teal-500 to-blue-500 bg-size-200 bg-pos-10 hover:bg-pos-90"
