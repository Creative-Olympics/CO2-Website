...
<div data-scroll>
	<div class="hero bg-cover bg-center" style="background-image: url('banner/final.jpg')">
		...
		<div class="flex flex-col relative">
			<div class="absolute w-full h-full hero-content text-center text-neutral-content flex-col">
				<span class="uppercase text-sm font-semibold font-sans mb-2 mt-4">Event starts in</span>
